...
class Curl {
	...
	public function _simple_call($method, $url, $params = array(), $options = array())
	{
		...
		if ($method === 'get')
		{
			...
			$this->http_login($this->username, $this->password);
			$this->option(CURLOPT_HTTPHEADER, array("X-API-KEY: " . $this->apiKey));			
		}
	...
	public function put($params = array(), $options = array())
	{
		...
		$this->option(CURLOPT_HTTPHEADER, array('X-HTTP-Method-Override: PUT', "X-API-KEY: " . $this->apiKey));
	}
